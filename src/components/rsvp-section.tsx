...
export function RSVPSection({ guestName, hasGuestParam }: RSVPSectionProps) {
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => {
      ...
      const particleCount = Math.max(
        36,
        Math.floor(110 * (timeLeft / duration)),
      );
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      invitation_for: activeGuestName,
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-[17px] leading-8 text-stone-700">
          Please confirm your presence for Aarav Krishna&apos;s Noolukettu ceremony.
        </p>
      </div>
      ...
      >
        <div className="flex items-center justify-center gap-3 text-[11px] uppercase tracking-[0.28em] text-[var(--color-sage-strong)]">
          <span className={step === 1 ? "opacity-100" : "opacity-45"}>
            Page 1
          </span>
          <span className="h-px w-10 bg-current/30" />
          <span className={step === 2 ? "opacity-100" : "opacity-45"}>
            Page 2
          </span>
        </div>
          ...
          <>
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              >
                ...
                <span className="mt-3 block text-[15px] text-stone-600">
                  Your blessings will still be with Aarav and the family.
                </span>
              </button>
            </div>
          ...
          <>
            <div className="text-center">
              ...
              <p className="mt-2 text-[15px] leading-7 text-stone-600">
                Choose which parts of the gathering you can join, set guest count, and leave a note if you like.
              </p>
            </div>
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <span className="mt-2 block text-[14px] text-stone-500">
                      Tap to {ceremonyAttending ? "mark unavailable" : "join the naming ritual"}
                    </span>
                  </button>
                  ...
                  >
                    ...
                    <span className="mt-2 block text-[14px] text-stone-500">
                      Tap to {receptionAttending ? "mark unavailable" : "join the family gathering"}
                    </span>
                  </button>
                </div>
              </div>
            ...
            <label className="block rounded-[26px] border border-[var(--color-sage-strong)]/12 bg-white/88 p-6">
              ...
              <textarea
                ...
                rows={5}
                placeholder="Share a blessing or note for Aarav and the family..."
